 ...
 * the user already configured — arranged as a One-Dark-style editor scheme:
 * a slate-black ground with green woven into the desktop texture and the
 * focused frame, silver prose, and the syntax accents doing semantic work —
 * green for you and for success, blue for the agent, purple for tools,
 * orange while something runs, soft red for failure, cyan for code, the
 * comment grey for reasoning. Selections are black-on-green and the default
 * button white-on-blue, so the accents stay a vocabulary rather than
 * decoration. Dropdowns, lists and dialogs sit on light surfaces, which is
 * what keeps every role legible on a light theme too.
 */
export const ANSI: Skin = {
  id: 'ansi',
  name: 'ANSI',
  description: "A One-Dark-style editor palette in your terminal's own sixteen colours.",
  ansi16: true,
  palette: {
    desktop: { fg: 10, bg: 0 },
    desktopText: { fg: 10, bg: 0 },
    shadow: { fg: 0, bg: 0 },
    windowFrame: { fg: 8, bg: 0 },
    windowTitle: { fg: 7, bg: 0 },
    windowFrameActive: { fg: 10, bg: 0 },
    windowTitleActive: { fg: 15, bg: 0 },
    windowBody: { fg: 7, bg: 0 },
    windowIcon: { fg: 10, bg: 0 },
    windowGrip: { fg: 15, bg: 0 },
    scrollBar: { fg: 8, bg: 0 },
    scrollThumb: { fg: 0, bg: 10 },
    menuBar: { fg: 7, bg: 0 },
    menuItem: { fg: 7, bg: 0 },
    menuItemActive: { fg: 0, bg: 12 },
    menuFrame: { fg: 0, bg: 7 },
    menuNormal: { fg: 0, bg: 7 },
    menuSelected: { fg: 0, bg: 10 },
    menuDisabled: { fg: 8, bg: 7 },
    menuShortcut: { fg: 4, bg: 7 },
    statusBar: { fg: 8, bg: 0 },
    statusKey: { fg: 10, bg: 0 },
    statusLabel: { fg: 8, bg: 0 },
    statusLine: { fg: 7, bg: 0 },
    inputFrame: { fg: 8, bg: 0 },
    inputFrameActive: { fg: 10, bg: 0 },
    inputBody: { fg: 15, bg: 0 },
    inputPrompt: { fg: 10, bg: 0 },
    inputHint: { fg: 8, bg: 0 },
    dialogStatic: { fg: 0, bg: 7 },
    dialogFocused: { fg: 0, bg: 10 },
    dialogDefault: { fg: 15, bg: 4 },
    listNormal: { fg: 0, bg: 7 },
    listFocused: { fg: 0, bg: 10 },
    ...
    toolBody: { fg: 7, bg: 0 },
    toolRunning: { fg: 11, bg: 0 },
    toolSuccess: { fg: 10, bg: 0 },
    toolError: { fg: 9, bg: 0 },
    diffAdded: { fg: 10, bg: 0 },
    diffRemoved: { fg: 9, bg: 0 },
    diffMeta: { fg: 8, bg: 0 },
    code: { fg: 14, bg: 0 },
    notice: { fg: 7, bg: 0 },
    warning: { fg: 11, bg: 0 },
