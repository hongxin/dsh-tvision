 ...
 * the user already configured — arranged as the WordPerfect-style dark green,
 * so it reads as an eye-comfort scheme of its own rather than as a faded copy
 * of the blue one. The correct choice for someone whose terminal is already
 * tuned, and the only skin guaranteed legible on a light background.
 */
export const ANSI: Skin = {
  id: 'ansi',
  name: 'ANSI',
  description: "A dark-green eye-comfort scheme in your terminal's own sixteen colours.",
  ansi16: true,
  palette: {
    desktop: { fg: 10, bg: 2 },
    desktopText: { fg: 10, bg: 2 },
    shadow: { fg: 0, bg: 0 },
    windowFrame: { fg: 10, bg: 2 },
    windowTitle: { fg: 2, bg: 10 },
    windowFrameActive: { fg: 15, bg: 2 },
    windowTitleActive: { fg: 0, bg: 10 },
    windowBody: { fg: 7, bg: 2 },
    windowIcon: { fg: 2, bg: 10 },
    windowGrip: { fg: 15, bg: 2 },
    scrollBar: { fg: 10, bg: 2 },
    scrollThumb: { fg: 2, bg: 10 },
    menuBar: { fg: 0, bg: 10 },
    menuItem: { fg: 0, bg: 10 },
    menuItemActive: { fg: 15, bg: 2 },
    menuFrame: { fg: 0, bg: 7 },
    menuNormal: { fg: 0, bg: 7 },
    menuSelected: { fg: 15, bg: 2 },
    menuDisabled: { fg: 8, bg: 7 },
    menuShortcut: { fg: 2, bg: 7 },
    statusBar: { fg: 0, bg: 10 },
    statusKey: { fg: 15, bg: 2 },
    statusLabel: { fg: 0, bg: 10 },
    statusLine: { fg: 0, bg: 10 },
    inputFrame: { fg: 10, bg: 2 },
    inputFrameActive: { fg: 15, bg: 2 },
    inputBody: { fg: 15, bg: 2 },
    inputPrompt: { fg: 10, bg: 2 },
    inputHint: { fg: 8, bg: 2 },
    ...
    listSelected: { fg: 15, bg: 2 },
    listDisabled: { fg: 8, bg: 7 },
    userLabel: { fg: 10, bg: 2 },
    assistantLabel: { fg: 15, bg: 2 },
    bodyText: { fg: 7, bg: 2 },
    reasoning: { fg: 8, bg: 2 },
    toolHeader: { fg: 11, bg: 2 },
    toolBody: { fg: 7, bg: 2 },
    toolRunning: { fg: 15, bg: 2 },
    toolSuccess: { fg: 10, bg: 2 },
    toolError: { fg: 9, bg: 2 },
    diffAdded: { fg: 10, bg: 2 },
    diffRemoved: { fg: 9, bg: 2 },
    diffMeta: { fg: 6, bg: 2 },
    code: { fg: 6, bg: 2 },
    notice: { fg: 7, bg: 2 },
    warning: { fg: 11, bg: 2 },
